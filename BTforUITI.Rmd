...
A common case will be when we have no prior information or knowledge about the variable of interest.  In this case we will want to use an noninformative prior distribution.
